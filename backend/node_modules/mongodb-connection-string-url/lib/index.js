...
class ConnectionString extends URLWithoutHost {
    constructor(uri, options = {}) {
        ...
        if (!looseValidation && !connectionStringHasValidScheme(uri)) {
            throw new MongoParseError('Invalid scheme, expected connection string to start with "mongodb://" or //readWrite:readWrite1@bruinsonboard.dzmdx9f.mongodb.net/?retryWrites=true&w=majority&appName=BruinsOnBoard":process.env.MONGO_URI://"');
        }
